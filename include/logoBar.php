<div class="row justify-content-center mx-auto my-3 order-2 order-lg-1 w-100">
    <!-- Search bar code -->
    <div class="col-9 order-2 order-md-1 col-md-4 d-flex align-items-center w-100">
    ...
    <div class="col-12 order-md-2 col-md-4 my-2">
        <a href="../Home/index.php" role="button" >
            <img src="../../img/Level_Logo_Title1.png" alt="Level Logo" class="d-block w-md-100 logoPic" />
        </a>
    </div>
    <!-- PayPal shopping cart code -->
    <div class="col-3 order-3 col-md-4 d-flex align-items-center text-md-right ml-md-auto">
        <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" class="mx-md-auto" >
