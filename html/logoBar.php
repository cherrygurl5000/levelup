<div class="row justify-content-center my-3">
    ...
    <div class="col-4 d-flex align-items-center">
        <form class="form-inline my-2 col-12" id="searchForm">
            <input class="form-control" type="search" id="searchBar" name="searchBar" placeholder="Search" aria-label="Search">
            <button class="btn btn-secondary my-sm-0 h-100" type="submit"><i class="fas fa-search"></i></button>
        </form>
    </div>
    <!-- The logo that takes you back to the homepage -->
    <div class="col-4">
        <a href="<?php echo HOME; ?>" role="button" >
            <img src="../img/Level_Logo_Title1.png" alt="Level Logo" class="logoPic" />
        </a>
    </div>
